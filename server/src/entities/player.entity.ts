...
@Entity('tbl_players')
@Index(['playerCode']) // ✅ Fixed - dùng property name
@Index(['fullName'])   // ✅ Fixed - dùng property name
...
export class Player {
  ...
  @Column({ name: 'player_code', type: 'varchar', length: 20, unique: true, nullable: true })
  playerCode?: string;
  ...
  @Column({ name: 'dominant_hand', type: 'varchar', length: 15, nullable: true })
  dominantHand?: string;
  ...
  @Column({ name: 'secondary_positions', type: 'text', array: true, nullable: true })
