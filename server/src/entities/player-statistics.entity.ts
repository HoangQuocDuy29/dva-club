...
export class PlayerStatistics {
  ...
  @Column({ name: 'serve_percentage', type: 'decimal', precision: 5, scale: 2, default: 0 })
  servePercentage: number;

  @Column({ name: 'attack_percentage', type: 'decimal', precision: 5, scale: 2, default: 0 })
  attackPercentage: number;

  @Column({ name: 'reception_percentage', type: 'decimal', precision: 5, scale: 2, default: 0 })
